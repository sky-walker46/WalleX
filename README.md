Wallex Logo
Wallex - Enterprise Student Finance Manager

Intelligent AI-driven financial management engineered with enterprise-grade React, Node.js, and Google Gemini.

Live Demo Backend API Stack
...
You can explore the live application at: wallex-opal.vercel.app
...
Ensure you have Node.js installed on your machine and a free Google AI Studio API Key.
...
HttpOnly Cookies: JWTs are strictly passed via headers unavailable to DOM JavaScript execution.
Helmet.js Headers: Protects the API against clickjacking and sniffing.
CORS Explicit Whitelisting: Strict origin rejection.
Zod Parsing: Impossible to crash the API via malformed JSON payloads due to runtime schema validation.
📝 License
